...
export default function Intro() {
  const { passIntro } = useChapterContext();

  useKeyPress("Enter", passIntro);
      ...
      >
        ...
        >
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Doors of Abyss: The Eternal Chase</DialogTitle>
                <DialogDescription className="text-sm">
                  ...
                  <br />
                  <br />
                  <strong>Enter</strong> key selects options, and continues the
                  game.
                  <br />
                  <strong>Up and down arrows</strong> can be used to navigate
                  between options.
                  <br />
                  <br />
                  Built by Niklas Lepistö & Jani Reijonen.
                  <br />
                  <br />
                  <a
                    className="inline-block"
                    href="https://github.com/laznic/doors-of-abyss"
                    target="_blank"
